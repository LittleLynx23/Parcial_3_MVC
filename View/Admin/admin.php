    ...
    <div class="col-12 col-xl-12 mb-4 mb-xl-0">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-9">
                        <h3 class="font-weight-bold text-primary">Admins</h3>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">Listado de admins en base de datos</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a 
                                        ...
                                        href="<?php echo BASE_URL?>admin/editar?id=<?php echo $id?>">
                                            Editar
                                    </a>
                                    <button 
                                        type="button" 
                                        class="btn btn-xs btn-danger" 
                                        onclick="eliminar(<?php echo $id?>,'tadmin','nAdmin_id')">
                                            Eliminar
                                    </button>  
                                </td>
                            </tr>
      ...
      function eliminar(id_del,tabla,campo){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url:'<?php echo BASE_URL?>admin/eliminar',
                    type: 'POST',
