    ...
    <div class="col-12 col-xl-12 mb-4 mb-xl-0">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-9">
                        <h3 class="font-weight-bold text-primary">Libros</h3>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">Listado de Libros en base de datos</p>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $fila['nAutor_fk']?></td>
                                <td><?php echo $fila['lEstado']?></td>
                                <td><?php echo $fila['nPrograma_fk']?></td>
                                
                                <td>
                                    <a 
                                        type="button" 
                                        class="btn btn-xs btn-info" 
                                        href="<?php echo BASE_URL?>libro/editar?id=<?php echo $id?>">
                                            Editar
                                    </a>
                                    <button 
                                        type="button" 
                                        class="btn btn-xs btn-danger" 
                                        onclick="eliminar(<?php echo $id?>,'tlibro','nLibro_id')">
                                            Eliminar
                                    </button>  
                                </td>
                            </tr>
      ...
      function eliminar(id_del,tabla,campo){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url:'<?php echo BASE_URL?>libro/eliminar',
                    type: 'POST',
